...
TIP: Si l'opération de création du cluster est lancée, mais que son échec se termine, il se peut que le mot de passe d'administration ONTAP que vous définissez ne s'applique pas. Dans ce cas, contactez le support technique NetApp pour obtenir de l'aide.
