...
Prise en charge de VMware ESXi mise à jour:: À partir de ONTAP 9.13.1, VMware ESXi 8.0 GA (build 20513097) est pris en charge avec la version matérielle 4 et les versions ultérieures.
